...
const App = () => {
  ...
  return (
    <div className="relative h-full overflow-hidden bg-[radial-gradient(circle_at_20%_20%,rgba(244,114,182,0.12),transparent_35%),radial-gradient(circle_at_80%_0%,rgba(249,168,212,0.14),transparent_40%),#14070f] text-slate-50">
      ...
      <div className="relative z-10 h-full overflow-y-auto overscroll-contain px-4 py-4 sm:px-6 sm:py-6 lg:px-10">
